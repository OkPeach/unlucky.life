...
function ethbubble() {
  ...
  var xmlhttp = new XMLHttpRequest();
  var url =
    "https://api.etherscan.io/api?module=stats&action=ethprice&apikey=FH12Z2IYGM3JKD1RN42NG6VHSXV73YX61H";
  ...
  setTimeout(function () {
    document.getElementById("dataeth").style.color = "white";
  }, 200);
  ...
  fetch("https://blockchain.info/q/addressbalance/" + btcAddress.value)
    ...
    .then(function (json) {
      ...
      document.getElementById("btc-balance").innerHTML =
        "Balance = " + btcfinal.toFixed(8) + " BTC";
      document.getElementById("btc-usd-balance").innerHTML =
        "Balance = " + usdconverted.toFixed(2) + " USD";
  ...
  function parseJson(json) {
    ...
    fetch(
      "https://api.etherscan.io/api?module=account&action=balance&address=" +
        ethAddress.value +
        "&tag=latest&apikey=FH12Z2IYGM3JKD1RN42NG6VHSXV73YX61H"
    )
      .then(function (response) {
